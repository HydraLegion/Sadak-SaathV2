...
const DEMO_POTHOLES: Pothole[] = [
  { id: 'demo-1', lat: 21.2514, lng: 81.6296, severity: 'critical', confidence: 0.94, status: 'pending', address: 'MG Road, Raipur', jurisdictionId: 'CG-Central', departmentId: null, description: 'Demo pothole', mediaUrls: [], thumbnailUrl: null, detectedAt: new Date(), verifiedAt: null, verifiedBy: null, resolvedAt: null, createdBy: 'demo', createdAt: new Date(), updatedAt: new Date() },
  { id: 'demo-2', lat: 21.2564, lng: 81.6346, severity: 'high', confidence: 0.87, status: 'verified', address: 'GE Road, Shankar Nagar', jurisdictionId: 'CG-Central', departmentId: null, description: 'Demo pothole', mediaUrls: [], thumbnailUrl: null, detectedAt: new Date(), verifiedAt: null, verifiedBy: null, resolvedAt: null, createdBy: 'demo', createdAt: new Date(), updatedAt: new Date() },
  { id: 'demo-3', lat: 21.2539, lng: 81.6190, severity: 'medium', confidence: 0.76, status: 'in_progress', address: 'Pandri Road', jurisdictionId: 'CG-Central', departmentId: null, description: 'Demo pothole', mediaUrls: [], thumbnailUrl: null, detectedAt: new Date(), verifiedAt: null, verifiedBy: null, resolvedAt: null, createdBy: 'demo', createdAt: new Date(), updatedAt: new Date() },
  { id: 'demo-4', lat: 21.2639, lng: 81.6240, severity: 'low', confidence: 0.68, status: 'resolved', address: 'Shankar Nagar', jurisdictionId: 'CG-Central', departmentId: null, description: 'Demo pothole', mediaUrls: [], thumbnailUrl: null, detectedAt: new Date(), verifiedAt: null, verifiedBy: null, resolvedAt: null, createdBy: 'demo', createdAt: new Date(), updatedAt: new Date() },
  { id: 'demo-5', lat: 21.2589, lng: 81.6040, severity: 'critical', confidence: 0.92, status: 'pending', address: 'Telibandha Road', jurisdictionId: 'CG-Central', departmentId: null, description: 'Demo pothole', mediaUrls: [], thumbnailUrl: null, detectedAt: new Date(), verifiedAt: null, verifiedBy: null, resolvedAt: null, createdBy: 'demo', createdAt: new Date(), updatedAt: new Date() },
]
    ...
    <div className={cn('flex gap-4 animate-fade-in', fullscreen && 'fixed inset-0 z-50 bg-background p-0')}>
      ...
      <div className="flex-1 relative">
        ...
        <div className={cn('h-full rounded-lg border overflow-hidden', fullscreen ? 'h-[calc(100vh-2rem)]' : 'h-[600px]')}>
          <MapContainer center={[21.2514, 81.6296]} zoom={zoom || 13} className="h-full w-full" whenReady={(map) => setMapInstance(map)} >
